...
private:
	...
	// END
	assert(token_text == "END", "\"END\" expected after instruction body.");
...
public:
	...
	assert(token_kind == IDENTIFIER, "Expected valid Program name.");
	...
	// END already pulled out in Prase_Block
